...
var title = '';
var backgroung = _react2.default.createElement('img', {
...
function displayFact(e) {
  var selectedAnimale = e.target.alt;
  var animalFacts = _animals.animals[selectedAnimale];
  var randomAnimaFact = Math.floor(Math.random() * animalFacts.facts.length);
  var funFact = animalFacts.facts[randomAnimaFact];
